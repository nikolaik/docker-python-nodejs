...
Last updated by bot: 2025-11-12
...
--- | --- | --- | ---
`python3.14-nodejs25` | 3.14.0 | 25.2.0 | trixie
`python3.14-nodejs25-bookworm` | 3.14.0 | 25.2.0 | bookworm
`python3.14-nodejs25-slim` | 3.14.0 | 25.2.0 | slim
...
`python3.13-nodejs25` | 3.13.9 | 25.2.0 | trixie
`python3.13-nodejs25-bookworm` | 3.13.9 | 25.2.0 | bookworm
`python3.13-nodejs25-slim` | 3.13.9 | 25.2.0 | slim
...
`python3.12-nodejs25` | 3.12.12 | 25.2.0 | trixie
`python3.12-nodejs25-bookworm` | 3.12.12 | 25.2.0 | bookworm
`python3.12-nodejs25-slim` | 3.12.12 | 25.2.0 | slim
...
`python3.11-nodejs25` | 3.11.14 | 25.2.0 | trixie
`python3.11-nodejs25-bookworm` | 3.11.14 | 25.2.0 | bookworm
`python3.11-nodejs25-slim` | 3.11.14 | 25.2.0 | slim
...
`python3.10-nodejs25` | 3.10.19 | 25.2.0 | trixie
`python3.10-nodejs25-bookworm` | 3.10.19 | 25.2.0 | bookworm
`python3.10-nodejs25-slim` | 3.10.19 | 25.2.0 | slim
